...
function cb(s,rt){return function(){if(!d){c(r.status===undefined?s:r.status,r.status===0?"Error":(r.response||r.responseText||rr),r);d=true;}};}
...
function updateElement(e,v,s){if(e){var tn=e.tagName;
if(typeof v=="object"){for(k in v){if(v.hasOwnProperty(k)){var vk=v[k];
if(k=="_"){if(tn=="path"||tn=="rect"){e.setAttribute("data-v",vk);}else{e.innerHTML=vk;}}
